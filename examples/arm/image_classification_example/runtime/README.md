1. Make sure you have setup the Ethos-U ExecuTorch dependencies by running the examples/arm/setup.sh script. See the (readme)[../examples/README.md] for instructions on how to do the setup.
